...
//        melodyConfig.setVelocityRateOfChange(Constants.SECOND_IN_MILLIS);
        ...
        TempoStrategy tempoStrategy = StrategyFactory.getTempoStrategy(10, 25, Util.getSeconds(9));
        DynamicsStrategy dynamicsStrategy = StrategyFactory.getDynamicsStrategy(2, 45, Util.getSeconds(1));
