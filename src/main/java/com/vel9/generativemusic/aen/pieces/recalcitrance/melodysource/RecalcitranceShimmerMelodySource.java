package com.vel9.generativemusic.aen.pieces.recalcitrance.melodysource;
...
public class RecalcitranceShimmerMelodySource {
    ...
    public static MelodySource getMelody(){
        ...
        DynamicsStrategy dynamicsStrategy = StrategyFactory.getVariablePeakDynamicsStrategy(1, 15, 45, 65, Util.getSeconds(1));
