package com.vel9.generativemusic.examples.stream.melodysource;
...
public class StreamBatelMelodySource {
    ...
    public static MelodySource getMelody(){
        ...
        TempoStrategy tempoStrategy = StrategyFactory.getUpwardTempoStrategy(100, 260, Util.getSeconds(11));
        DynamicsStrategy dynamicsStrategy = StrategyFactory.getGradualUpwardDynamicsStrategy(1, 60, Util.getSeconds(1));
